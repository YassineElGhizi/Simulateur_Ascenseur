...
public class Elevator implements Runnable{
    ...
    Elevator() {
        ...
        closeIcon = new ImageIcon("C:\\Users\\ElGhiziYassine\\Desktop\\JavaWorkSpace\\ProjetJavaAscenseur\\src\\img\\closed.jpg");
        openIcon = new ImageIcon("C:\\Users\\ElGhiziYassine\\Desktop\\JavaWorkSpace\\ProjetJavaAscenseur\\src\\img\\opened.jpg");
        openingIcon = new ImageIcon("C:\\Users\\ElGhiziYassine\\Desktop\\JavaWorkSpace\\ProjetJavaAscenseur\\src\\img\\opening.jpg");
        closingIcon = new ImageIcon("C:\\Users\\ElGhiziYassine\\Desktop\\JavaWorkSpace\\ProjetJavaAscenseur\\src\\img\\closing.jpg");
        ...
        try {
            while(true) {
                ...
                if(checkTo()) {
                    findNearest();
                    if(state == 1)
                        elevatorstate.setText("↑ " + String.valueOf(etageActuel));
                    else
                        elevatorstate.setText("↓ " + String.valueOf(etageActuel));
                    move();
                }
    ...
    private void findNearest() {
        int upNear;
        int downNear;
        for(upNear = etageActuel; upNear < Const.floornumber+1 && to[upNear-1] == false; upNear++);
        for(downNear = etageActuel; downNear > 0 && to[downNear-1] == false  ; downNear--);
        ...
        else if((upNear-etageActuel) < (etageActuel-downNear)) {
            state = 1;
            destination = upNear;
        }
        else {
    ...
    private void move() {
        ...
        for(int i = 1; etageActuel < destination; i++, etageActuel++) {
            ...
            floors[etageActuel-1].setBackground(Color.WHITE);
            floors[etageActuel].setBackground(Color.GRAY);
            elevatorstate.setText("↑ " + String.valueOf(etageActuel+1));
        }
        ...
        for(int i = 1; etageActuel > destination; i++, etageActuel--) {
            ...
            floors[etageActuel-1].setBackground(Color.WHITE);
            floors[etageActuel-2].setBackground(Color.GRAY);
            elevatorstate.setText("↓ " + String.valueOf(etageActuel-1));
        }
    ...
    public void traverseTo() {
        if(floorButtons[etageActuel-1].getBackground() == Color.RED)
            floorButtons[etageActuel-1].setBackground(Color.WHITE);
    ...
    private void opening() {
        ...
        while(System.currentTimeMillis()-now < closeopenTime) {
            if(to[etageActuel-1] == true)
                to[etageActuel-1] = false;
            if(checkDoorButton() == 1)
                open.setBackground(Color.WHITE);
            else if(checkDoorButton() == 2) {
                close.setBackground(Color.WHITE);
